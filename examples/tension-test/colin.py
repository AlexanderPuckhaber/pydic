...
correl_wind_size = (60,60) # the size in pixel of the correlation windows
correl_grid_size = (5,5) # the size in pixel of the interval (dx,dy) of the correlation grid


# read image series and write a separated result file 
# pydic.init('./5 - Test1/*.png', correl_wind_size, correl_grid_size, "result.dic")

# images_path = os.path.join("..", "..", "..", "blah", "Photos", "5 - Test1")

# pydic.init(str(images_path) + "*.png", correl_wind_size, correl_grid_size, "result.dic")
